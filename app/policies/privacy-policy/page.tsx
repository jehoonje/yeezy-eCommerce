...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen flex justify-center pt-4 leading-[1.5]">
      <main className="max-w-[660px] py-8 px-44 md:px-9">
        <div className="text-left">
          ...
          <p className="mb-4">
            This Privacy Policy describes how Yeezy (the "Site", "we", "us", or
            "our") collects, uses, and discloses your personal information when
            you visit, use our services, or make a purchase from
            yeezy-yzy.myshopify.com (the "Site") or otherwise communicate with
            us regarding the Site (collectively, the "Services"). For purposes
          ...
          <p className="mb-10">Changes to This Privacy Policy</p>
          <p className="mb-10">
          ...
          <p className="mb-10">What Personal Information We Collect</p>
          <p className="mb-10">
          ...
          <p className="mb-10">Information We Collect Directly from You</p>
          <p className="mb-4">
          ...
          <p className="mb-10">Information We Collect about Your Usage</p>
          <p className="mb-10">
          ...
          <p className="mb-10">Information We Obtain from Third Parties</p>
          <p className="mb-4">
          ...
          <p className="mb-10">How We Use Your Personal Information</p>
          <p className="mb-4">
            ...
            send notifications to you related to your account, purchases,
            ...
            any returns and exchanges and other features and functionalities
            related to your account. We may also enhance your shopping
            experience by enabling Shopify to match your account with other
            Shopify services that you may choose to use. In this case, Shopify
            will process your information as set forth in its Privacy Policy and
          ...
          <p className="mb-10">How We Disclose Personal Information</p>
          <p className="mb-4">
          ...
          <table className="mb-10 border-collapse border border-gray-300 w-full text-left">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  Basic contact details and certain order and account
                  information
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  Order information, shopping information and customer support
                  information
                </td>
              </tr>
              <tr>
                ...
                <td className="border border-gray-300 p-2">Usage Data</td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-2">Geolocation Data</td>
                <td className="border border-gray-300 p-2">
                  Locations determined by an IP address or other technical
                  measures
                </td>
              </tr>
            </tbody>
          </table>
          <p className="mb-10">Categories of Recipients:</p>
          ...
          <p className="mb-10">Third Party Websites and Links</p>
          <p className="mb-4">
            ...
            security policies and other terms and conditions.
          </p>
          <p className="mb-4">
            ...
            reliability of information found on these sites.
          </p>
          <p className="mb-4">
            ...
            also be viewable by other users of the Services and/or users of
            those third-party platforms without limitation as to its use by us
            or by a third party.
          </p>
          <p className="mb-10">
          ...
          <p className="mb-10">Children's Data</p>
          <p className="mb-4">
          ...
          <p className="mb-10">Security and Retention of Your Information</p>
          <p className="mb-4">
          ...
          <p className="mb-10">Your Rights</p>
          <p className="mb-4">
          ...
          <p className="mb-10">Complaints</p>
          <p className="mb-10">
          ...
          <p className="mb-10">International Users</p>
          <p className="mb-4">
          ...
          <p className="mb-4">help@yeezy.com</p>
        </div>
      </main>
    </div>
  );
